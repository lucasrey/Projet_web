...
$query = "SELECT a.lien, i.nom, i.description, i.prix, m.compositeur, m.format, m.genre, m.editeur, m.dateParution FROM item i, image a, musique m WHERE m.ID_musique = i.ID AND i.ID = a.ID AND i.ID = '$ID'";
    ...
    echo "<div class=col-lg-1>";
     echo "<div>";
          echo "<p class=card-text>".$compositeur."</p>";
        echo "</div>";
    echo "</div>";
          echo "<div class=col-lg-1>";
        echo "<div>";
          echo "<p class=card-text>".$genre."</p>";
        echo "</div>";
    echo "</div>";
          echo "<div class=col-lg-1>";
        echo "<div>";
    ...
    echo "</div>";
          echo "<div class=col-lg-1>";
        echo "<div>";
          echo "<p class=card-text>".$dateParution."</p>";
        echo "</div>";
    echo "</div>";
    echo "<div class=col-lg-1>";
