...
<nav class="navbar navbar-expand-md fixed-top navbar-light bg-light">
  ...
  <div class="container">
    <p></p>
    <h3 align="center">Suppression : Sports et Loisir </h3>  
      ...
      <div class="col-lg-4">
        <p></p>
                ...
                <form method="post">
                     ...
                     <label>ID des items Sports et Loisirs</label>  
                     <select name="livre"> 
...
//echo $Pseudo;
 ...
 {  
   ...
   // echo $ID; 
      ...
      $query = "SELECT distinct i.ID FROM item i, sportloisir l WHERE i.ID = l.ID_sportloisir AND i.ID_vd = '$ID'"; 
...
$sql="ALTER TABLE sportloisir
ADD CONSTRAINT ID_sportloisir FOREIGN KEY (ID) REFERENCES item(ID) ON DELETE CASCADE";
if(mysqli_query($connect, $sql)){
	echo '<script>alert("Table musique : altered")</script>';

}
$sql = "DELETE FROM sportloisir WHERE ID = '$IDMusique'";
if(mysqli_query($connect, $sql)){
