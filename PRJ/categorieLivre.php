  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <h1 class="my-4">Livres</h1>
          <p>Profitez de toute notre gamme de livres</p>
...
$connect = mysqli_connect("localhost", "root", "", "test");  
      ...
      $query = "SELECT distinct i.nom, i.ID, m.lien, i.prix, i.description FROM item i, image m, livre l WHERE i.ID = m.ID AND i.ID = l.ID_livre AND i.ID_cl is NULL AND i.statut = '0'"; 
             ...
             echo "<img class=card-img-top src=".$Lien.">";
              echo "<div class=card-body>";
                echo "<h4 class=card-title>";
                  ...
                  echo "<a href='article.php?ID=".$ID."&amp;nom=".$Nom."'>".$Nom."</a>";
                echo "</h4>";
                echo "<h5>".$Prix."€</h5>";
