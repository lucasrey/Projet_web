  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <h1 class="my-4">Sports et Loisir</h1>
          <p>Profitez de toute notre gamme de produits sports et loisir</p>
...
$connect = mysqli_connect("localhost", "root", "", "test");  
      ...
      $query = "SELECT distinct i.nom, i.ID, m.lien, i.prix, i.description FROM item i, image m, sportloisir l WHERE i.ID = m.ID AND i.ID = l.ID_sportloisir AND i.ID_cl is NULL AND i.statut = '0'"; 
             ...
             echo "<img class=card-img-top src=".$Lien.">";
              echo "<div class=card-body>";
                echo "<h4 class=card-title>";
                  ...
                  echo "<a href='ItemSportLoisir.php?ID=".$ID."&amp;nom=".$Nom."'>".$Nom."</a>";
                echo "</h4>";
                echo "<h5>".$Prix."€</h5>";
