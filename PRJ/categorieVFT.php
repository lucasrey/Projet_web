...
$connect = mysqli_connect("localhost", "root", "", "test");  
      ...
      $query = "SELECT distinct m.lien FROM item i, image m, vetement l, variation v WHERE i.ID = m.ID AND i.ID = l.ID_vetement AND i.nom = '$Nom' AND l.ID = v.ID_variation AND v.genre = 'Femme' AND i.ID_cl is NULL AND i.statut is NULL AND l.type = '$Type' AND v.couleur = '$Couleur' AND v.taille = '$Taille'"; 
