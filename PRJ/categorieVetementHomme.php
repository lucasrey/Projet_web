  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <h1 class="my-4">Vetements Homme</h1>
          <p>Profitez de toute notre gamme de vetements masculins</p>
...
$connect = mysqli_connect("localhost", "root", "", "test");  
      ...
      $query = "SELECT distinct i.nom, i.ID, l.type, i.description, i.prix, v.couleur, v.taille FROM item i, image m, vetement l, variation v WHERE i.ID = m.ID AND i.ID = l.ID_vetement AND l.ID = v.ID_variation AND v.genre = 'Homme' AND i.ID_cl is NULL AND i.statut is NULL"; 
          ...
          echo "<div class=col-lg-8 col-md-6 mb-4>";
              ...
              echo "<div class=card-body>";
                echo "<h4 class=card-title>";
                    ...
                    echo "</h4>";
                    echo "<h5>".$Type."</h5>";
                   echo "<a href='categorieVHT.php?nom=".$Nom."&amp;ID=".$ID."&amp;type=".$Type."&amp;description=".$Description."&amp;prix=".$Prix."&amp;couleur=".$Couleur."&amp;taille=".$Taille."'><button class=btn btn-primary btn-lg>Voir l'article</button></a>";
