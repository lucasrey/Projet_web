        ...
        <a class="dropdown-item" href="#">Particulier</a>
         ...
         <li class="nav-item">
           ...
           <div class="container" style="width:500px;">  
                ...
                <p></p>
                a>
                Gestionnaire Items : Supression
                </a>
                <div>
                <a href="SLivre.php">Livre</a>
                <a href="SMusique.php">Musique</a>
                <a href="SVetements.php">Vetements</a>
                <a href="SSportLoisir.php">Sport et Loisirs</a>
              </div>
                <a>
                ...
                <a href="Vetement.php">Vetements</a>
                <a href="SportLoisir.php">Sport et Loisirs</a>
                </div>
